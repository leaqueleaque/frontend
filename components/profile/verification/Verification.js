            ...
            <div className="verification__container">
                ...
                >
                    <div className="verification__info verification__info-not">
                        ...
                        <div className="verification__info-text">
                            Account not verified
                        </div>
                    </div>
                    <div className="verification__inputs">
                        <div
                            className="verification__input verification__input-first"
                        ...
                        <div
                            className="verification__input verification__input-last"
                            style={{ background: 'none' }}
                        >
                            <label
                                className="verification__input-label"
                        ...
                        <div
                            ...
                            style={{ background: 'none' }}
                        >
                            <div className="verification__input-label">
                                Select country
                            </div>
                            <div
                        ...
                        <div
                            className="verification__input verification__input-address"
                            style={{ background: 'none' }}
                        >
                            <label
                                className="verification__input-label"
                        ...
                        <div
                            className="verification__input verification__input-phone"
                            style={{ background: 'none' }}
                        >
                            <div className="verification__input-label">
                                Phone number
                        ...
                        <div
                            className="verification__input verification__input-date"
                            style={{ background: 'none' }}
                        >
                            <label
                                className="verification__input-label"
                        ...
                        <div
                            className="verification__input verification__input-id"
                            style={{ background: 'none' }}
                        >
                            <label
                                className="verification__input-label"
                    ...
                    <div className="verification__file">
                        <div className="verification__document">
                            ...
                            <div className="verification__file-description">
                                Please provide a clear photo/scan of your
                                document. Please make sure that the photo/scan
                                is complete and clearly visible, in JPG/PNG
                                format
                            </div>
                        ...
                        <div className="verification__selfie">
                            ...
                            <div className="verification__file-description">
                                Please upload a photo of yourself that clearly
                                shows your face.
                            </div>
                            <div className="verification__file-box">
                                <label className="verification__file-input">
