        ...
        <>
            <div className="formP2p">
                <div className="formP2p__top-btn-box">
                    <div className="formP2p__top-btn left" onClick={openWallet}>
                        BUY
                    </div>
                    <div
                        className="formP2p__top-btn right active"
                        onClick={openWallet}
                    >
                        SELL
                    </div>
                ...
                <div
                    className="formP2p__mobile-btn"
                    onClick={mobileWrapperToggle}
                >
                    <svg
                        width="16"
                        height="18"
                    ...
                    >
                        <path
                            d="M0 0h16v3.674l-5.818 5.333v6.743L5.818 18V9.007L0 3.674V0Z"
                            fill="#fff"
                        ></path>
                    </svg>
                </div>
                ...
                >
                    <div className="formP2p__form">
                        ...
                        <div
                            className="formP2p__mobile-close"
                            onClick={mobileWrapperToggle}
                        >
                            <svg
                                width="16px"
                        ...
                        <div className="formP2p__currency input-field s6">
                            ...
                            <div
                                className={`formP2p__coin coin-one ${
                                    coinActive ? 'active' : ''
                                }`}
                            ...
                            <div
                                className={`formP2p__currency-list list-coin-one ${
                                    listActive ? 'active' : ''
                                }`}
                            >
                                <div className="formP2p__coin-items coin-items-one">
                                    {currenciess.map((currency, index) => (
                                        <div
                                            className={`formP2p__currency-item ${
                                        ...
                                        >
                                            <img
                                                className="formP2p__currency-img"
                                                src={currency.imgSrc}
                                                alt=""
                                            />
                                            <div className="">
                                                <span className="formP2p__currency-sub">
                                                    {currency.code}
                                                </span>
                                                <span className="formP2p__currency-title">
                                                    &nbsp;&nbsp;{currency.name}
                                                </span>
                                            </div>
                                        </div>
                        ...
                        <div className="formP2p__currency input-field s6">
                            ...
                            />
                            <div
                                className={`formP2p__coin coin-two ${
                                    fiatActive ? 'active' : ''
                                }`}
                            ...
                            <div
                                className={`formP2p__currency-list list-coin-two ${
                                    fiatListActive ? 'active' : ''
                                }`}
                            >
                        ...
                        <div className="formP2p__currency input-field s6">
                            ...
                            <div
                                className={`formP2p__currency-list list-coin-three ${
                                    paymentListActive ? 'active' : ''
                                }`}
                            >
                        ...
                        <div className="formP2p__verification">
                            ...
                            <div className="formP2p__des">
                                Show ads of verified traders only
                            </div>
                        ...
                        <div className="formP2p__verification">
                            ...
                            <div className="formP2p__des">
                                Show ads of traders who are online only
                            </div>
                            <div className="switch">
                                <label>
                                    <input type="checkbox" />
