export function PopupVerifP2P({handleCloseClick, errorMessage, isVerif, userCard = false}) {
    ...
    return (
        <div id="p2p_error_modal" className="popup__container">
            <div className="popup">
                <div className="popup__close" id="close_modals" onClick={handleCloseClick}>
                    <svg
                ...
                <div className="popup__right">
                  ...
                  <span style={{fontWeight: 400}}>
                    {errorMessage}
                        ...
                        <p>
                  <span style={{fontWeight: 400}}>
                    {isVerif ? '' : 'Thank you for choosing our exchange service!'}
                  </span>
                        </p>
                    </div>
                    <a href={isVerif ? '../profile/deposit' : '../profile/verification'} className="popup__right-button" >
