        ...
        <div id="p2p_error_modal" className="popup__container">
            <div className="popup">
                ...
                <div className="popup__left" style={{ width: '300px' }}>
                    {isVerif ? (
                        <img
                            src="https://cdn-icons-png.flaticon.com/512/2266/2266216.png"
                            alt=""
                            style={{
                                width: '200px',
                                height: '200px',
                        ...
                        >
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M146.58 76.183C165.144 99.2979 185.867 120.951 183.866 140.47C181.903 159.95 157.138 177.296 133.432 183.855C109.686 190.375 87.001 186.107 63.9623 177.019C40.9629 167.971 17.6102 154.102 11.6052 134.346C5.63948 114.629 17.0215 88.9851 33.8589 66.2653C50.6964 43.585 72.9894 23.7891 92.2995 26.1994C111.649 28.5702 128.015 53.1076 146.58 76.183Z"
                                fill="white"
                            ></path>
                            <path
                                d="M192.672 162.344C192.672 163.724 191.553 164.844 190.172 164.844C188.791 164.844 187.672 163.724 187.672 162.344C187.672 160.963 188.791 159.844 190.172 159.844C191.553 159.844 192.672 160.963 192.672 162.344Z"
                                fill="#14A38B"
                            ></path>
                            <circle
                                cx="129.047"
                            ...
                            <rect
                                ...
                                height="2.46827"
                                rx="1.23414"
                                transform="rotate(-110.108 52.8125 69.0449)"
                                fill="#0D0938"
                            ></rect>
                            <rect
                                width="10.9016"
                                height="2.46827"
                                rx="1.23414"
                                transform="matrix(0.483166 -0.875529 -0.875529 -0.483166 67.8105 70.3672)"
                                fill="#0D0938"
                            ></rect>
                            <rect
                                width="10.9016"
                                height="2.46827"
                                rx="1.23414"
                                transform="matrix(0.154579 -0.98798 -0.98798 -0.154579 61.5781 67.8887)"
                                fill="#0D0938"
                            ></rect>
                            <rect
                                x="33.5117"
                            ...
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M153.559 132.498C153.559 144.277 144.01 153.826 132.23 153.826C120.451 153.826 110.902 144.277 110.902 132.498C110.902 120.719 120.451 111.17 132.23 111.17C144.01 111.17 153.559 120.719 153.559 132.498ZM146.019 146.287C142.211 150.094 137.615 151.998 132.23 151.998C126.846 151.998 122.249 150.094 118.442 146.287C114.634 142.479 112.73 137.883 112.73 132.498C112.73 127.113 114.634 122.517 118.442 118.709C122.249 114.902 126.846 112.998 132.23 112.998C137.615 112.998 142.211 114.902 146.019 118.709C149.827 122.517 151.73 127.113 151.73 132.498C151.73 137.883 149.827 142.479 146.019 146.287Z"
                                fill="#0D0938"
                            ></path>
                            <rect
                                x="138.164"
                                ...
                                height="19.5"
                                rx="0.914062"
                                transform="rotate(45 138.164 124.953)"
                                fill="#0D0938"
                            ></rect>
                            <rect
                                width="1.82812"
                                height="19.5"
                                rx="0.914062"
                                transform="matrix(-0.707107 0.707107 0.707107 0.707107 125.666 124.951)"
                                fill="#0D0938"
                            ></rect>
                        </svg>
                    )}
                ...
                <div className="popup__right">
                    ...
                    <div className="popup__right-description">
                        <p>
                            <span style={{ fontWeight: 400 }}>
                                {!userCard
                                    ? isVerif
                                        ? 'To participate in P2P bidding, make a security deposit of 1000 USDT to your account.'
                                        : 'To participate in P2P bidding on Coin Tranche'
                                    : isVerif
                                    ? 'We noticed that you still do not have full access to the Coin Tranche platform functionality!'
                                    : 'To participate in P2P bidding on Coin Tranche'}
                            </span>
                        </p>
                        <br />
                    ...
                    >
                        {isVerif ? 'Make a Deposit' : 'Start Verification'}
                    </a>
                </div>
            </div>
        </div>
