...
const TableUser = () => {
    ...
    const coinsWithoutUSD = cryptoDataArray.filter(
        (coin) => coin.index !== 'usd'
    );

    const getImage = (idx) => {
        let coins = imagesCoins.filter(
            (el) => el.index.toLowerCase() === idx.toLowerCase()
        )[0];
        let img =
                    ...
                    <div className="userNavigation__box">
                        <div className="userNavigation__search-box">
                            ...
                            <div className="userNavigation__checkbox">
                                <label
                                    className="userNavigation__features-label"
                                    for="userNavigation-remember"
                                >
                                    Hide zero balances
                                    <input
                        ...
                        <div className="userNavigation__tabBtn-box">
                            <a href="deposit">
                                <div className="userNavigation__tabBtn">
                                    Deposit
                                </div>
                            </a>
                            <a href="withdraw">
                    ...
                    <div className="tableUser__box">
                        <div className="tableUser__wrapper">
                            <div className="tableUser__names">
                                <div className="tableUser__name tableUser__name-coin">
                                    Coin
                                </div>
                                    ...
                                    .map((data) => (
                                        ...
                                        >
                                            ...
                                            <div className="tableUser__item-balance balance_amount_hide">
                                                <span className="search_my_balance">{`${new Intl.NumberFormat(
                                                    'en-US'
                                                ).format(
                                                    data.own_price
                                                )}`}</span>{' '}
