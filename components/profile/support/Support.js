...
const Sup = () => {
    ...
    const submitMessage = () => {
        ...
        if (accessToken) {
            axios
                .post(process.env.NEXT_PUBLIC_BASE_URL + '/chat/', form, {
                    headers: {
        ...
        <section className="verification" style={{ marginTop: '10px' }}>
            ...
            <div className="verification__container">
                <div className="chat__title">
                    <img
                        className="chat__img"
                        src="/img/support_avatar.png"
                        alt=""
                    />
                    <div className="chat__title-name1">
                ...
                <div className="chat__title-name">
                    Choose the right department
                </div>
                <div
                    className="verification__input verification__input-country chat__type-message"
